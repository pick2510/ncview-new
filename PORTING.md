...
- **Still not separately re-verified in one final side-by-side pass** against the original Xaw binary: overlay rendering and `.ncviewrc` round-tripping through a real save/restart cycle. Left as follow-up QA.
