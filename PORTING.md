...
- **Still not separately re-verified in one final side-by-side pass** against the original Xaw binary: `.ncviewrc` round-tripping through a real save/restart cycle. Left as follow-up QA.
